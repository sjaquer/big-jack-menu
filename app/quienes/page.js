...
export default function QuienesPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#020204] via-[#0a0a0c] to-[#020204] text-white font-sans py-12 px-4">
      <div className="max-w-5xl mx-auto bg-neutral-900 rounded-xl shadow-2xl overflow-hidden border-2 border-neutral-800">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#8a5010] to-[#d99133] p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl font-bold tracking-widest text-black bg-[#d99133] inline-block px-4 py-1 transform -rotate-1">MANIFIESTO ESTRATÉGICO</p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 space-y-10">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <h3 className="text-2xl text-[#d99133] font-bold uppercase">Nuestros 4 pilares</h3>
            <div className="h-1 w-full bg-neutral-800" />
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-neutral-800 p-6 rounded-lg text-center border-t-4 border-[#d99133]">
              <div className="w-16 h-16 bg-[#d99133]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="text-[#d99133]" />
              </div>
            ...
            <div className="bg-neutral-800 p-6 rounded-lg text-center border-t-4 border-[#d99133]">
              <div className="w-16 h-16 bg-[#d99133]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-[#d99133]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M13 2L11 22L7 20L13 2Z"/></svg>
              </div>
          ...
          <div className="mt-6 text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <Link href="/" className="inline-flex items-center gap-2 bg-[#d99133] px-4 py-3 rounded-full font-black text-black">🍔 Volver al menú</Link>
        ...
        <div className="bg-[#020204] p-6 text-center border-t border-neutral-800">
